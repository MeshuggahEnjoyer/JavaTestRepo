...
public class MyHashMap<K,V> {
    ...
    private void afterNodeAccess(Node<K,V> p) { }
    private void afterNodeInsertion(boolean evict) { }
    private void afterNodeRemoval(Node<K,V> p) { }
    ...
    private final Node<K,V> removeNode(int hash, Object key, Object value,
    ...
    private static final class TreeNode<K,V> extends Entry<K,V> {
    ...
    private static class Entry<K,V> extends MyHashMap.Node<K,V> {
